            ...
            <section class="flex flex-col gap-4 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-slate-500">
                        View stock quantity before, changed quantity, and quantity after movement.
                    </p>
                </div>
                ...
                <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 lg:col-span-2">
                    ...
                    <dl class="mt-5 grid gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm font-semibold text-slate-950">
                                {{ stockMovement.warehouse?.code }} - {{ stockMovement.warehouse?.name }}
                            </dd>
                        </div>
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm font-semibold text-slate-950">
                                {{ stockMovement.product?.sku }} - {{ stockMovement.product?.name }}
                            </dd>
                        </div>
                    ...
                    <div class="mt-6 space-y-4">
                        ...
                        <div>
                            ...
                            <div class="mt-1 text-2xl font-bold text-emerald-300">
                                {{ Number(stockMovement.quantity_changed) >= 0 ? '+' : '' }}{{ formatQuantity(stockMovement.quantity_changed) }}
                            </div>
                        </div>
            ...
            >
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500">
                            This movement was created from a stock receipt document.
                        </p>
                    </div>
                ...
                <dl class="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-sm font-semibold text-slate-950">
                            {{ referenceReceipt.purchase_order?.supplier?.name || '-' }}
                        </dd>
                    </div>
