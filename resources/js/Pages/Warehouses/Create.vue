        ...
        <div class="mx-auto max-w-3xl space-y-6">
            ...
            >
                ...
                <p class="mt-2 text-sm text-slate-500">
                    Add a new warehouse location for inventory stock.
                </p>
            </section>
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            class="mt-1 w-full rounded-xl border-slate-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            placeholder="Example: Bangkok Main Warehouse"
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            class="mt-1 w-full rounded-xl border-slate-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            placeholder="Example: Bangna, Bangkok"
                        />
